...
public class MainApplication extends JFrame {
    ...
    private SprintEvaluationPanel sprintEvaluationPanel; // Add this line
    ...
    public MainApplication() {
        ...
        // Create SQLExecuter and SprintEvaluationDAO instances
        SQLExecuter sqlExecuter;
        try {
            sqlExecuter = new SQLExecuter();
            SprintEvaluationDAO evaluationDAO = new SprintEvaluationDAO(sqlExecuter);
            sprintEvaluationPanel = new SprintEvaluationPanel(evaluationDAO); // Instantiate SprintEvaluationPanel here
        } catch (SQLException e) {
            e.printStackTrace();
            return; // Exit if there’s an error connecting to the database
        }
        ...
        mainPanel.add(sprintEvaluationPanel, "SprintEvaluationPanel"); // Add this line to include SprintEvaluationPanel
